import { Length, Split, ToString, ToStringTuple } from "./utility";
 ...
 */
export type StringToNumberStringTuple<T extends string> =
...
export type StringToNumber<S extends string> = S extends NumberToString<infer P>
    ? P
    : never;
